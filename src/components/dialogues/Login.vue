  ...
  <div class="login">
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" status-icon>
        <el-form-item v-if="loginState" prop="" ref="nameRef">
          <el-input
            v-model="form.name"
            placeholder="用户名/邮箱"
            auto-complete="off"
        ...
        <el-form-item v-if="!loginState" prop="name" ref="nameRef">
          <el-input
            v-model="form.name"
            placeholder="邮箱"
            auto-complete="off"
        ...
        <div id="checkCodeLine" v-if="!loginState">
          ...
          <el-button id="checkCodeBtn" @click="getCode" :loading="gettingCode"
            >获取验证码</el-button
          >
        </div>
      </el-form>
      <div class="middle">
        <el-button
          ...
          type="primary"
          @click="submit()"
          >{{ loginState ? "登入" : "注册" }}</el-button
        >
        <el-button type="text" @click="setLoginState(!loginState)">{{
          loginState ? "没有账号，前往注册" : "已有账号，前往登入"
        }}</el-button>
      </div>
