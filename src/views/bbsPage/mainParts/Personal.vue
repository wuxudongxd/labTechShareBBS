              ...
              <el-container>
                ...
                <el-main>
                  ...
                  <div class="info_body">
                      ...
                      <el-form-item label="个人介绍">
                        <el-card>
                          <div style="white-space:pre">
                            {{personalData.introduction?personalData.introduction:"还没有介绍哦"}}
                          </div>
                        </el-card>
                      </el-form-item>
                      <el-form-item label="性别">
                    ...
                    <el-tooltip v-if="!editing&&currentUserId==this.$route.params.id" class="item" effect="dark" content="修改个人信息" placement="left">
  ...
  export default {
    ...
    methods:{
      ...
      onSubmit(){
        ...
        UpdatePersonInfo(this.$route.params.id,this.form).then(
          res=>{
      ...
      loadPersonInfo(){
        ...
        LoadPersonInfo(this.$route.params.id).then(
          res=>{
            //console.log(res);
            this.personalData=res.data;
            if(!this.personalData.contact.hasOwnProperty("website")){
            ...
            this.form.contact=JSON.parse(JSON.stringify(this.personalData.contact));
          }
        );
      },
      startEditInfo(){
        ...
        //console.log(this.form)
        //console.log(this.form.enrollment_time)
        this.editing=true;
